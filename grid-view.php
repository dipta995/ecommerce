                    ...
                    <div class="product-block ">
                      ...
                      <div class="item col-md-8 col-sm-8 col-xs-8">
                        <div class="product-details">
                          ...
                          <div class="addto-cart"><a href="product-detail-view.php?productid=<?php echo $result['productId']; ?>">Show Product</a></div>
          ...
          <div id="right">
            ...
            <div class="product-grid-view">
              ...
              if (  isset($_GET['catid'])) {
                ...
                if ($catid ) {
                  $getApd = $pd->getAllProductByCat($catid);
                }elseif ($brandid) {
                  $getApd = $pd->getAllProductByBr($brandid);
                }else{
                  $getApd = $pd->getAllProduct();
                }
                ?>
                <?php
                  ...
                  <div class="product-details">
                    <div class="product-name">
                      <h3><a href="product-detail-view.php?productid=<?php echo $result['productId'];?>"><?php echo $result['productName'];?> </a></h3>
                          <span  class="review"> <span class="rate">
