          ...
          <div id="right">
            <div class="sidebar-widget">
              ...
              <ul class="title-toggle">
                <li><a href="blog.php">Photoshop (10)</a></li>
                <li><a href="blog.php">WordPress (4)</a></li>
                <li><a href="blog.php">Core PHP (5)</a></li>
                <li><a href="blog.php">Graphic Design (15)</a></li>
                <li><a href="blog.php">e-Commerce Developars (3)</a></li>
                <li><a href="blog.php">Android Dev (7)</a></li>
                <li><a href="blog.php">Web Designing (9)</a></li>
              </ul>
            </div>
            <div class="sidebar-widget">
              <div class="sidebar-title">
            ...
            <div class="sidebar-widget latest-blog">
              ...
              <ul class="title-toggle">
                <li>
                  <div class="blog-post ">
                    <div class="item col-md-4">
                      <div class="image"><a href="blog.php"><img class="img-responsive" title="T-shirt" alt="T-shirt" src="images/blog2.jpg"></a> </div>
                    </div>
                    <div class="item col-md-8">
                      <div class="blog-details">
                        <div class="blog-name">
                          <h5><a href="blog.php">Black African Print Pencil Skirt </a></h5>
                ...
                <li>
                  <div class="blog-post ">
                    <div class="item col-md-4">
                      <div class="image"><a href="blog.php"><img class="img-responsive" title="T-shirt" alt="T-shirt" src="images/blog3.jpg"></a> </div>
                    </div>
                    <div class="item col-md-8">
                      <div class="blog-details">
                        <div class="blog-name">
                ...
                <li>
                  <div class="blog-post ">
                    <div class="item col-md-4">
                      <div class="image"><a href="blog.php"><img class="img-responsive" title="T-shirt" alt="T-shirt" src="images/blog5.jpg"></a> </div>
                    </div>
                    <div class="item col-md-8">
                      <div class="blog-details">
                        <div class="blog-name">
                ...
                <li>
                  <div class="blog-post ">
                    <div class="item col-md-4">
                      <div class="image"><a href="blog.php"><img class="img-responsive" title="T-shirt" alt="T-shirt" src="images/blog4.jpg"></a> </div>
                    </div>
                    <div class="item col-md-8">
                      <div class="blog-details">
                        <div class="blog-name">
